...
using ElmahCore.Mvc;
using ElmahCore;
using dockerdot.Api.Filters;
using dockerdot.Business.Installer;

namespace dockerdot.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dockerdot API", Version = version + "-" + branch});
            });
