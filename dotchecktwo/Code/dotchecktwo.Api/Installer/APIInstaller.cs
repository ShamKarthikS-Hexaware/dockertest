...
using ElmahCore.Mvc;
using ElmahCore;
using dotchecktwo.Api.Filters;
using dotchecktwo.Business.Installer;

namespace dotchecktwo.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotchecktwo API", Version = version + "-" + branch});
            });
