...
using ElmahCore.Mvc;
using ElmahCore;
using reredotest.Api.Filters;
using reredotest.Business.Installer;

namespace reredotest.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "reredotest API", Version = version + "-" + branch});
            });
