...
{
    public class When_updating_human : UsingHumanServiceSpec
    {
        ...
        public override void Context()
        {
            ...
            _humanRepository.Update(_human.Id, _human).Returns(_human);
        ...
        {
            _humanRepository.Received(1).Update(_human.Id, _human);
