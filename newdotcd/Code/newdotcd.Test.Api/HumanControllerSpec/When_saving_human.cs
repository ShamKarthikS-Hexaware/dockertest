...
{
    public class When_saving_human : UsingHumanControllerSpec
    {
        ...
        public override void Context()
        {
            ...
            _humanService.Save(_human).Returns(_human);
        }
        ...
        {
            _humanService.Received(1).Save(_human);
        ...
        public void Appropriate_result_is_returned()
        {
            ...
            var resultList = (Human)resultListObject;
