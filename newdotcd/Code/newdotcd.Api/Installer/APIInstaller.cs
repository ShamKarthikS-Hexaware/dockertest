...
using ElmahCore.Mvc;
using ElmahCore;
using newdotcd.Api.Filters;
using newdotcd.Business.Installer;

namespace newdotcd.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "newdotcd API", Version = version + "-" + branch});
            });
