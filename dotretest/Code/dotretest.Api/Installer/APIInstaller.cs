...
using ElmahCore.Mvc;
using ElmahCore;
using dotretest.Api.Filters;
using dotretest.Business.Installer;

namespace dotretest.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotretest API", Version = version + "-" + branch});
            });
