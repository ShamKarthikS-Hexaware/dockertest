...
using ElmahCore.Mvc;
using ElmahCore;
using newdotmake.Api.Filters;
using newdotmake.Business.Installer;

namespace newdotmake.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "newdotmake API", Version = version + "-" + branch});
            });
