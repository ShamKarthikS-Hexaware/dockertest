...
using ElmahCore.Mvc;
using ElmahCore;
using dotcheck.Api.Filters;
using dotcheck.Business.Installer;

namespace dotcheck.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotcheck API", Version = version + "-" + branch});
            });
